    ...
    if request.method == 'POST':
        ...
        try:
            ...
            results = [
                ...
                # 'N1': round(100 * len(kanji.n1) / len(N1)),
                # 'N2': round(100 * len(kanji.n2) / len(N2)),
                # 'N3': round(100 * len(kanji.n3) / len(N3)),
                # 'N4': round(100 * len(kanji.n4) / len(N4)),
                # 'N5': round(100 * len(kanji.n5) / len(N5)),
            ]
